...
$("#card-section").on('click', '.completed-btn', function(){
  var completeStatus= $(this).parents(".new-idea").attr("complete")
  $(this).parents(".new-idea").toggleClass('false')
     if ($(this).parents(".new-idea").attr("complete") === 'Not Completed'){
       $(this).parents(".new-idea").attr("complete") = 'Completed';
       completeStatus = "Completed";
       editComplete(this, completeStatus);
     }
     if ($(this).parents(".new-idea").attr("complete") === 'Completed'){
       $(this).parents(".new-idea").attr("complete") = 'Not Completed';
